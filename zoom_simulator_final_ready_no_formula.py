...
- **Refraction and Corneal Spherical Aberration:** Set the actual hypermetropic power, along with the Pre-operative Corneal Spherical Aberration (6mm) for each eye. This sets the amount of depth of focus that will be induced by pure refractive treatment.

**Refraction and Corneal Spherical Aberration:** Set the actual hypermetropic power, along with the Pre-operative Corneal Spherical Aberration (6mm) for each eye. This sets the amount of depth of focus that will be induced by pure refractive treatment (red bar). This is an empirically derived regression formula based on clinical experience.

  \[
  \text{{DOF}} = (0.25 \times \text{{SphEq}}) \times \left(\frac{{4}}{{3}}\right)^2 \times \left(1 - 1.5 \times \text{{SA}}_\text{{preop}}\right)
  \]
  This is a self-developed regression-based empirical formula derived from clinical experience, assuming a fixed pupil size of 3mm.
