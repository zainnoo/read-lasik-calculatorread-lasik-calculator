...
se_re = st.sidebar.number_input("RE Spherical Equivalent (D)", 0.0, 6.0, 0.0, 0.25)
se_le = st.sidebar.number_input("LE Spherical Equivalent (D)", 0.0, 6.0, 0.0, 0.25)

st.sidebar.header("🌀 Preop Corneal SA (6mm)")
sa_re = st.sidebar.number_input("RE Spherical Aberration (SA)", 0.0, 0.6, 0.0, 0.01)
sa_le = st.sidebar.number_input("LE Spherical Aberration (SA)", 0.0, 0.6, 0.0, 0.01)
...
# Removed duplicate SE+SA section
se_re = st.sidebar.number_input("RE Spherical Equivalent (D)", 0.0, 6.0, 0.0, 0.25)
se_le = st.sidebar.number_input("LE Spherical Equivalent (D)", 0.0, 6.0, 0.0, 0.25)
