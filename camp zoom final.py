...
- **Refraction and Corneal Spherical Aberration:** Set the actual hypermetropic power, along with the Pre-operative Corneal Spherical Aberration (6mm) for each eye. This sets the amount of depth of focus that will be induced by pure refractive treatment (red bar). This is DOF if from an empirically derived regression formula based on clinical experience.
