...
# Right Eye
re_sphere = st.sidebar.number_input("RE Sphere (D)", 0, 10.0, 0.0, 0.25, key="re_sphere")
re_cyl = st.sidebar.number_input("RE Cylinder (D)", -6.0, 6.0, 0.0, 0.25, key="re_cyl")
actual_re = re_sphere  # use this as earlier "actual RE refraction"
se_re = re_sphere + (re_cyl / 2)

# Left Eye
le_sphere = st.sidebar.number_input("LE Sphere (D)", 0, 10.0, 0.0, 0.25, key="le_sphere")
le_cyl = st.sidebar.number_input("LE Cylinder (D)", -6.0, 6.0, 0.0, 0.25, key="le_cyl")
...
st.image("dof_formula.png", caption="DOF Induced by Refraction and SA", use_column_width=True)
